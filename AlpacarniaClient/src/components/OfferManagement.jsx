...
function OfferManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editMode
        ? `${import.meta.env.VITE_API_URL}/api/offer/edit/${editId}`
        : `${import.meta.env.VITE_API_URL}/api/offer/add`;
  ...
  const handleDeleteOffer = async (offerId) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/offer/delete/${offerId}`,
        {
          method: "DELETE",
          credentials: "include",
        }
  ...
  const fetchOffers = async () => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/offer/admin/management`,
        {
          method: "GET",
          credentials: "include",
          headers: {
